...
<head>
    ...
    <link rel="stylesheet/less" type="text/css" href="../../public/teamsplayers.less">
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="?page=top100" href="#"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="?page=top100">TOP 100 <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="?page=team">TEAM</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="?page=player">PLAYER</a>
            </li>
            <li class="nav-item">
...
<?php if(isset($player)): ?>
    <div class="name">
        <ol class="surnames">
            ...
            <li class="s"><a href="?page=ratingplayers&id_player=<?= $p['id_player'];?>"><?= $p['name'],' ', $p['surname'];?></a></li>
            <?php endforeach; ?>
        </ol>
    </div>
<?php endif; ?>
